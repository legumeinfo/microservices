...
# module
import macro_synteny_paf
from macro_synteny_paf.database import connectToRedis
from macro_synteny_paf.grpc_server import run_grpc_server
from macro_synteny_paf.http_server import run_http_server
...
def parseArgs():
    ...
    parser = argparse.ArgumentParser(
        prog=macro_synteny_paf.__name__,
        description="""
    ...
    parser.add_argument(
        ...
        action="version",
        version=f"""
        %(prog)s {macro_synteny_paf.__version__} schema
        {macro_synteny_paf.__schema_version__}
        """,
    )
