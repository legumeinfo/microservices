...
'''Provides distutils command classes for the pairwise macro synteny blocks Python setup process.'''
...
class BuildProtos(setuptools.Command):
  ...
  def run(self):
    ...
    proto_dir = \
      os.path.join(self.distribution.package_dir[''], 'pairwise_macro_synteny_blocks/proto')
