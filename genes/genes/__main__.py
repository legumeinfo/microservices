...
# module
import genes
from genes.database import connectToRedis
...
def parseArgs():
  ...
  parser = argparse.ArgumentParser(
    prog=genes.__name__,
    description='A microservice that returns the gene objects corresponding to the given gene names.',
    formatter_class=argparse.ArgumentDefaultsHelpFormatter)
  parser.add_argument(
    '--version',
    action='version',
    version=f'%(prog)s {genes.__version__}',
  )
