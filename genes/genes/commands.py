...
"""Provides distutils command classes for the genes Python setup process."""
...
class BuildProtos(setuptools.Command):
    ...
    def finalize_options(self):
        ...
        self.proto_build_dir = os.path.abspath(
            os.path.join(self.build_lib, "genes/proto")
        )
    ...
    def build_package_protos(self):
        ...
        # importlib.resources instead of the deprecated pkg_resources, which
