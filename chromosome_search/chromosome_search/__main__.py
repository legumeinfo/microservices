...
from chromosome_search.database import connectToRedis
from chromosome_search.grpc_server import run_grpc_server
...
def parseArgs():
    ...
    parser = argparse.ArgumentParser(
        prog=chromosome_search.__name__,
        description="""
    ...
    parser.add_argument(
        ...
        action="version",
        version=f"""
        %(prog)s {chromosome_search.__version__} schema
        {chromosome_search.__schema_version__}
        """,
    )
    ...
    parser.add_argument(
        ...
        type=str,
        help=f"""The file events should be logged in (can also be specified using the
