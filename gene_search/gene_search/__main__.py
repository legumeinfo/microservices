...
# module
import gene_search
from gene_search.database import connectToRedis
from gene_search.grpc_server import run_grpc_server
...
def parseArgs():
    ...
    parser = argparse.ArgumentParser(
        prog=gene_search.__name__,
        description="""
        A microservice for finding gene names similar to the given query.
        """,
    ...
    parser.add_argument(
        ...
        action="version",
        version=f"""
        %(prog)s {gene_search.__version__} schema {gene_search.__schema_version__}
        """,
    )
    ...
    parser.add_argument(
        ...
        default="WARNING",
        help=f"""What level of events should be logged (can also be specified using the
